...
export default function CartHaveProduct() {
  return (
    <div
      className="w-[18.75rem] z-50 bg-white hidden opacity-0 group-hover:flex group-hover:opacity-100 max-h-[460px] absolute right-0 top-[50px] 
    px-4 pt-4 border shadow-lg rounded-lg flex-col justify-between"
    >
      <div className="flex flex-col gap-2 flex-1 overflow-y-auto bg-white listProducts">
        <ItemProduct />
        <ItemProduct />
        <ItemProduct />
        <ItemProduct />
      ...
      <div className="border-t py-4">
        <p className="text-xs text-center">
          Chúng tôi giảm giá vận chuyển xuống chỉ còn 15K!
        </p>
      </div>
    </div>
  );
...
function ItemProduct() {
  ...
  return (
    <div className="relative cursor-pointer pb-4 border-b last:border-none bg-white">
